...
| Atualização de BIOS | NÃO COMPROVADO | nenhuma fonte | Sem política de risco/recuperação | Bloqueia |
...
| Testes de memória | Parcial | "Teste de stress (CPU, GPU, RAM)" | Ferramenta/critério não definidos | Precisa formalizar |
| Testes de estabilidade | Sim | "Teste de stress" | — | OK |
| Validação de armazenamento | NÃO COMPROVADO | nenhuma fonte | — | Bloqueia |
...
| Registro das peças | NÃO COMPROVADO | nenhuma fonte | Sem termo de recebimento de peças | Bloqueia |
| Garantia da mão de obra | Parcial | "Garantia na montagem" (sem prazo/escopo) | Prazo e exclusões não definidos | Bloqueia |
| Política para peças do cliente | NÃO COMPROVADO | FAQ permite trazer peças, sem regras | Procedência, defeito de fábrica, prazo de troca, item usado | Bloqueia |
