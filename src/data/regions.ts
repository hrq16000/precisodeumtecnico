...
export const citiesData: Record<string, CityData> = {
  "curitiba": {
    ...
    seoDescription: "Assistência técnica em Curitiba - PR. Técnicos especializados em informática, elétrica, CFTV, ar-condicionado. Atendimento 24h via WhatsApp. Visita a partir de R$ 99,90.",
  ...
  "sao-jose-dos-pinhais": {
    ...
    seoDescription: "Assistência técnica em São José dos Pinhais - PR. Informática, CFTV, elétrica, ar-condicionado. Técnico vai até você! WhatsApp 24h. A partir de R$ 99,90.",
    population: "329.058",
  ...
  "pinhais": {
    ...
    seoDescription: "Assistência técnica em Pinhais - PR. Informática, elétrica, CFTV, ar-condicionado, notebooks. Atendimento 24h via WhatsApp. Visita técnica a partir de R$ 99,90.",
    population: "132.157",
  ...
  "colombo": {
    ...
    seoDescription: "Assistência técnica em Colombo - PR. Técnicos especializados em informática, elétrica, CFTV, ar-condicionado. WhatsApp 24h. A partir de R$ 99,90.",
    population: "246.540",
  ...
  "almirante-tamandare": {
    ...
    seoDescription: "Assistência técnica em Almirante Tamandaré - PR. Informática, elétrica, CFTV, ar-condicionado. WhatsApp 24h. A partir de R$ 99,90.",
    population: "121.887",
