...
export const servicesData: Record<string, ServiceData> = {
  ...
  "pc-gamer": {
    ...
    metaTitle: "Montagem de PC Gamer Curitiba | Upgrade e Manutenção Especializada 24h",
    metaDescription: "Montagem de PC Gamer em Curitiba. Configuração personalizada, upgrade de placa de vídeo, processador, memória RAM. Cable management profissional. A partir de R$ 150,00.",
    subtitle: "Sua máquina dos sonhos montada por especialistas",
    description: "Montagem profissional de PC Gamer com cable management perfeito, instalação de water cooler e otimização de sistema. Upgrade de componentes, manutenção e suporte para gamers exigentes.",
    longDescription: "Transforme sua experiência de jogo com um PC Gamer montado por especialistas. Oferecemos consultoria completa para escolha dos melhores componentes dentro do seu orçamento, montagem profissional com cable management impecável, instalação de sistemas de refrigeração (air cooler e water cooler), configuração do sistema operacional e drivers, além de otimização para máxima performance em jogos. Também realizamos upgrades em PCs existentes: troca de placa de vídeo, processador, memória RAM, SSD NVMe, fonte e gabinete. Trabalhamos com as melhores marcas: NVIDIA, AMD, Intel, Corsair, NZXT, Cooler Master e outras.",
    image: "service-computer.jpg",
    icon: "Monitor",
    benefits: [
      "Consultoria especializada para sua necessidade",
      "Cable management profissional",
      "Instalação de water cooler/air cooler",
      "Configuração de BIOS otimizada",
      "Overclock seguro (se desejar)",
      "Windows original + drivers atualizados",
      "Teste de stress e temperatura",
    ...
    includedServices: [
      ...
      "Cable management profissional",
      "Instalação de air cooler/water cooler",
      "Aplicação de pasta térmica premium",
      "Instalação de Windows 10/11",
      "Instalação de drivers otimizados",
      "Configuração de BIOS/UEFI",
      "Teste de stress (CPU, GPU, RAM)",
      ...
      "Troca de fonte",
      "Troca de gabinete",
      "Instalação de RGB e iluminação"
    ],
    process: [
      { step: 1, title: "Consultoria", description: "Entendemos seus jogos, orçamento e expectativas" },
      { step: 2, title: "Orçamento de Peças", description: "Montamos configuração ideal com melhores preços" },
      { step: 3, title: "Aquisição", description: "Você compra as peças ou compramos para você" },
      { step: 4, title: "Montagem", description: "Montagem profissional com cable management" },
      { step: 5, title: "Configuração", description: "Windows, drivers, BIOS otimizada" },
      { step: 6, title: "Testes", description: "Teste de stress, temperatura e benchmarks" },
      { step: 7, title: "Entrega", description: "PC pronto para jogar com garantia" }
    ],
    pricing: [
      { name: "Montagem Completa", price: "A partir de R$ 200,00", description: "Montagem + cable management + configuração" },
      { name: "Montagem com Water Cooler", price: "A partir de R$ 300,00", description: "Inclui instalação do AIO" },
      { name: "Upgrade Placa de Vídeo", price: "A partir de R$ 100,00", description: "Instalação + drivers + teste" },
      { name: "Upgrade Processador", price: "A partir de R$ 100,00", description: "Troca + pasta térmica + teste" },
      { name: "Upgrade Memória RAM", price: "A partir de R$ 50,00", description: "Instalação + configuração XMP" },
      { name: "Limpeza + Pasta Térmica", price: "A partir de R$ 100,00", description: "Limpeza completa + pasta premium" },
      { name: "Organização de Cabos", price: "A partir de R$ 80,00", description: "Cable management em PC existente" },
      { name: "Instalação RGB", price: "A partir de R$ 80,00", description: "Fans, fitas LED, controlador" },
      { name: "Consultoria Online", price: "Grátis", description: "Ajudamos a escolher as peças" }
    ],
    faqs: [
      { question: "Vocês vendem as peças para montar o PC?", answer: "Podemos indicar as melhores lojas e promoções, ou comprar as peças para você (com acréscimo de taxa). Você também pode comprar as peças por conta própria e trazer para montagem." },
      { question: "Quanto custa um bom PC Gamer atualmente?", answer: "Depende dos jogos e resolução desejada. Para 1080p em jogos AAA: R$ 3.500-5.000. Para 1440p: R$ 5.000-8.000. Para 4K: R$ 8.000-15.000+. Fazemos configurações para todos os orçamentos." },
      { question: "Vocês fazem overclock?", answer: "Sim, fazemos overclock de CPU e memória RAM de forma segura, respeitando limites térmicos e de voltagem. O overclock pode trazer ganhos de 5-15% de performance dependendo do hardware." },
      { question: "Qual pasta térmica vocês usam?", answer: "Usamos pastas térmicas premium como Arctic MX-4, Thermal Grizzly Kryonaut ou Noctua NT-H1. São pastas de alta performance que duram anos sem ressecar." },
      { question: "Fazem manutenção em PC Gamer de outras marcas/lojas?", answer: "Sim! Fazemos manutenção, limpeza, upgrade e reparo em qualquer PC Gamer, independente de onde foi comprado ou montado." },
      { question: "Meu PC está com gargalo, vocês identificam?", answer: "Sim! Analisamos seu hardware e uso para identificar gargalos (bottleneck). Muitas vezes um upgrade específico (GPU, CPU ou RAM) resolve o problema sem precisar trocar tudo." },
      { question: "Vocês instalam water cooler custom (loop aberto)?", answer: "Fazemos instalação de water cooler AIO (all-in-one). Para loops customizados, avaliamos caso a caso pois requer experiência específica do cliente em manutenção." }
    ],
    relatedServices: ["informatica", "games", "notebooks"],
    keywords: ["montagem pc gamer curitiba", "upgrade pc gamer", "placa de vídeo curitiba", "cable management", "water cooler instalação", "pc gamer personalizado"]
  },
  "impressoras": {
    slug: "impressoras",
